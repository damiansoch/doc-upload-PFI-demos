...
// Brief mock "connecting to the signing provider" moment between clicking
// Sign now / Start in-person signing and the real "Check for update" state —
// makes the mock read as an actual signing flow instead of an instant swap.
