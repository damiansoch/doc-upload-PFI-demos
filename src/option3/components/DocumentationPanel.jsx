...
// collapsible section.
//
// No per-item accordion either — pending items show their one-line
// explanation and action directly (there's nothing left worth hiding behind
// a click once the copy is down to a single sentence), and completed items
// collapse to a compact confirmation row instead. The only accordion left is
// the parent "Documentation & Requirements" section itself.
